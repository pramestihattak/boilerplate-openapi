...
//
//	mockgen -source ./pkg/jwt/jwt.go -destination ./pkg/jwt/mock/jwt_mock.go
//
...
func (m *MockJWTInterface) Sign(data jwt.Auth) (string, error) {
	m.ctrl.T.Helper()
...
// Sign mocks base method.
func (m *MockJWTWriter) Sign(data jwt.Auth) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Sign", data)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
